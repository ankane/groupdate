...
module TestGroupdate
  ...
  def test_month_with_month_start_after_start
    Groupdate.month_start = 10
    assert_result_time :month, "2013-03-10 00:00:00 UTC", "2013-03-10 23:59:59"
  end

  def test_month_with_month_start_before_start
    Groupdate.month_start = 10
    assert_result_time :month, "2013-02-10 00:00:00 UTC", "2013-03-09 23:59:59"
  end

  def test_month_with_month_start_into_previous_year
    Groupdate.month_start = 10
    assert_result_time :month, "2013-12-10 00:00:00 UTC", "2014-01-09 23:59:59"
  end

  def test_month_with_month_start_into_longer_month
    Groupdate.month_start = 31
    assert_result_time :month, "2013-03-31 00:00:00 UTC", "2013-04-30 23:59:59"
  end

  def test_month_with_month_start_into_shorter_month
    Groupdate.month_start = 31
    expected = {
      # this extra key gets generated by the series generator when dates get rounded to the last day of the month
      utc.parse("2013-03-31 00:00:00 UTC") => 0,
      utc.parse("2013-04-30 00:00:00 UTC") => 1
    }
    assert_equal expected, result(:month, "2013-05-30 00:00:00 UTC")
  end

  def test_month_with_month_start_and_month_start_option
    Groupdate.month_start = 10
    assert_result_time :month, "2013-03-11 00:00:00 UTC", "2013-03-24 23:59:59", false, month_start: 11
  end

  def test_month_with_month_start_after_day_start_2am
    Groupdate.month_start = 10
    Groupdate.day_start = 2
    assert_result_time :month, "2013-03-10 02:00:00 UTC", "2013-03-10 02:00:00", false, day_start: 2
  end

  def test_month_with_month_start_before_day_start_2am
    Groupdate.month_start = 10
    Groupdate.day_start = 2
    assert_result_time :month, "2013-02-10 02:00:00 UTC", "2013-03-10 01:59:00", false, day_start: 2
  end

  def test_month_with_month_start_and_time_zone_after_start
    Groupdate.month_start = 10
    assert_result_time :month, "2013-02-10 00:00:00 PST", "2013-02-10 23:59:59 PST", true
  end

  def test_month_with_month_start_and_time_zone_before_start
    Groupdate.month_start = 10
    assert_result_time :month, "2013-02-10 00:00:00 PST", "2013-03-09 23:59:59 PST", true
  end

  def test_month_with_month_start_and_time_zone_into_previous_year
    Groupdate.month_start = 10
    assert_result_time :month, "2013-12-10 00:00:00 PST", "2014-01-09 23:59:59 PST", true
  end
