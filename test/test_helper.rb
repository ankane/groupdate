...
module TestGroupdate
  ...
  def test_zeros_excludes_end
    ...
    assert_equal expected, call_method(:day, :created_at, range: Date.parse("2013-05-01")...Date.parse("2013-05-02"))
  end
  ...
  def test_zeros_datetime
    ...
    assert_equal expected, call_method(:day, :created_at, range: DateTime.parse("2013-05-01")..DateTime.parse("2013-05-01"))
  end
